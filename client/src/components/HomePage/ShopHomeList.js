                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                                ...
                                <div className="row">
                                    <div className="col-lg-6 col-md-6 col-12">
                                        <div className="list-image overlay">
                                            ...
                                            <a href="abc" className="buy"><i className="fa fa-shopping-bag" /></a>
                                        </div>
                                    </div>
                                    <div className="col-lg-6 col-md-6 col-12 no-padding">
                                        <div className="content">
                                            <h4 className="title"><a href="abc">Licity jelly leg flat Sandals</a></h4>
                            ...
                            <div className="single-list">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-12 no-padding">
                                        <div className="content">
                                            <h5 className="title"><a href="abc">Licity jelly leg flat Sandals</a></h5>
